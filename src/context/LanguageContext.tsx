...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    visitApprovedSuccessDesc: "تم حفظ الفحص والتشخيص بنجاح في السجل الطبي. يمكنك الآن اعتماد الوصفة الطبية الإلكترونية أدناه، أو إشعار السكرتارية في حال استخدام وصفة ورقية.",
    notifyPaperRxBtn: "استخدام وصفة ورقية (إشعار السكرتارية بالتصوير)",
    notifyPaperRxSuccess: "تم إرسال إشعار فوري للسكرتارية لتصوير وأرشفة الوصفة الورقية",
  ...
  en: {
    ...
    visitApprovedSuccessDesc: "Diagnosis is saved to medical record. You can issue the electronic prescription below, or notify reception if using a paper prescription.",
    notifyPaperRxBtn: "Use Paper Prescription (Notify Reception)",
    notifyPaperRxSuccess: "Notification sent to reception to photograph paper prescription",
